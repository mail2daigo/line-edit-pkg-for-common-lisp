...
#+sbcl (load (get-pkg-path "line-edit-pkg.fasl"))
...
#+clisp (load (get-pkg-path "line-edit-pkg.fas"))
...
#+gcl (load (get-pkg-path "line-edit-pkg.o"))
...
(compile-file (get-src-path "NumberPlace.lisp"))
